...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Destructor of AtClusterizeTask");
}
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Initilization of AtClusterizeTask");
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Exec of AtClusterizeTask");
