...
/// Independent of AtViewerManager — only requires TEveManager.
///
/// Usage:
...
private:
   ...
   // Eve elements (owned by gEve, we just track pointers for cleanup)
   TEvePointSet *fClusterPoints{nullptr};
   TEvePointSet *fSmoothedPoints{nullptr};
   TEvePointSet *fFilteredPoints{nullptr};
   TEveStraightLineSet *fResidualLines{nullptr};
