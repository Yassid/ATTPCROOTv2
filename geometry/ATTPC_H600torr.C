/// @file ATTPC_H600torr.C
/// @brief AT-TPC geometry with the drift volume filled with H2 at 600 torr, 293 K
/// (rho = 6.616e-5 g/cm^3 = 8.27e-5 * 79993/100000 Pa) -- the a1954 12Be run condition.
/// The H1bar version is 27% too dense for a1954 and makes genfit material effects wrong.
/// Build:  root -b -q ATTPC_H600torr.C   (writes ATTPC_H600torr[_geomanager].root here)
/********************************************************************************
