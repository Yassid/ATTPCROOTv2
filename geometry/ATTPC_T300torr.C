 ...
 ********************************************************************************/
// 10Be(t,p)12Be: AT-TPC filled with T2 at 300 torr, 293 K (rho = 9.89854e-5 g/cm3).
// Identical to ATTPC_D300torr_v2 in every dimension -- 50 cm diameter, 100 cm drift, same aramid
// window and steel vessel -- so the ONLY difference between the (d,p) and (t,p) campaigns is the
// target gas and the reaction. Medium TargetT2_300, defined in media.geo next to TargetD2_300.
// Built by macro/Simulation/ATTPC/10Be_tp/, 2026-08-31.
//
...
void ATTPC_T300torr()
{
   ...
   // top->Draw("ogl");  // no OpenGL under WSL
   // top->Raytrace();
}
