...
/// AT-TPC in active-target mode for the 46Ar(3He,d)47K proposal.
/// The whole drift volume is the target: 3He + 5% CO2 (molar) at 300 torr, 293.15 K,
/// rho = 8.3128e-5 g/cm3 (see the He3CO2_300torr block in media.geo).
/// Over the 100 cm drift length that is 4.70 mg/cm2 of 3He = 9.4e20 at/cm2, i.e. the
/// same target thickness the proposal quotes for the 300 torr 3He gas cell -- so the
/// luminosity estimate carries over, without the cell wall or the isobutane.
/// Geometry is otherwise identical to ATTPC_H300torr.C: 50 cm diameter, 100 cm drift.

// Name of geometry version and output file
const TString geoVersion = "ATTPC_He3CO2_300torr";
const TString FileName = geoVersion + ".root";
const TString FileName1 = geoVersion + "_geomanager.root";

// Names of the different used materials which are used to build the modules
// The materials are defined in the global media.geo file
const TString MediumGas = "He3CO2_300torr";
...
void ATTPC_He3CO2_300torr()
{
   ...
   // top->Draw("ogl");   // OpenGL viewer crashes under WSL -- run headless
   // top->Raytrace();
}
