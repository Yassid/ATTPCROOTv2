...
#pragma link C++ class AtPSAMultiFit + ;
...
#pragma link C++ class AtPATTERN::AtTrackFinderHDBSCAN + ;
#pragma link C++ class AtPATTERN::AtTrackFinderRiemann + ;
...
#pragma link C++ class EventFit::AtFitterUKFMulti+;
#pragma link C++ class AtPatternBridgeTask+;
