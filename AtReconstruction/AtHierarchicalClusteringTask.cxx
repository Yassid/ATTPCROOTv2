...
AtHierarchicalClusteringTask::AtHierarchicalClusteringTask() : FairTask("AtHierarchicalClusteringTask")
{
   ...
   gLogger->Debug(MESSAGE_ORIGIN, "Defaul Constructor of AtHierarchicalClusteringTask");
   fPar = NULL;
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Destructor of AtHierarchicalClusteringTask");
}
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "SetParContainers of AtHierarchicalClusteringTask");
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Initilization of AtHierarchicalClusteringTask");
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Exec of AtHierarchicalClusteringTask");
...
{
   gLogger->Debug(MESSAGE_ORIGIN, "Finish of AtHierarchicalClusteringTask");
}
