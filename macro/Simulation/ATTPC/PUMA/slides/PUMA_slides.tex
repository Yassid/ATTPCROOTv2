...
\end{itemize}
\column{0.5\textwidth}
\centering\includegraphics[width=\linewidth]{figs/pad_zoom.png}\\
{\scriptsize A track fires a column of pads; colour = charge.}
\end{columns}
\end{frame}

\begin{frame}{A reconstructed event --- 2D pad plane}
\centering\includegraphics[height=.74\textheight]{figs/track_2d.png}\\
...
\centering\includegraphics[height=.74\textheight]{figs/track_3d.png}\\
...
\centering\includegraphics[height=.62\textheight]{figs/psa_fitshape.png}\\
...
\centering\includegraphics[width=\linewidth]{figs/pra_algo_cmp.png}
...
\centering\includegraphics[height=.66\textheight]{figs/pra_eff_vs_p.png}\\
...
\centering\includegraphics[width=\linewidth]{figs/pra_algo_vs_p.png}
...
\centering\includegraphics[width=\linewidth]{figs/pra_kaon_cmp.png}
...
\centering\includegraphics[height=.82\textheight]{figs/pra_examples.png}\\
...
\column{0.5\textwidth}
\centering\includegraphics[width=\linewidth]{figs/res_pi_dp.png}\\
{\scriptsize \(\pi^+\pi^-\) momentum residual: both fitters, \(\sigma\sim\)16--18\%.}
\end{columns}
\end{frame}

\begin{frame}{Kalman fits --- examples}
\centering\includegraphics[height=.82\textheight]{figs/fit_examples.png}\\
...
\begin{frame}{Resolution vs momentum --- the U-shape}
\begin{columns}
\column{0.6\textwidth}
\centering\includegraphics[width=\linewidth]{figs/res_vs_p.png}
\column{0.4\textwidth}
The momentum resolution is best in the middle (375--500 MeV/c) and degrades at both ends:
\begin{itemize}
\item \textbf{Low $p$:} \textbf{multiple scattering} ($\propto 1/p\beta$) perturbs the curvature --- an \emph{irreducible} floor. Both fitters converge, and tight curls also over-segment.
\item \textbf{High $p$:} tracks are \textbf{near-straight}, with little curvature/sagitta to measure.
\end{itemize}
Only in the measurement-limited middle does the sub-pad information help --- where GENFIT pulls ahead.
\end{columns}
\end{frame}
...
\begin{columns}
\column{0.56\textwidth}
\centering\includegraphics[width=\linewidth]{figs/bias_fix.png}
\column{0.44\textwidth}
...
\begin{columns}
\column{0.52\textwidth}
\centering\includegraphics[width=\linewidth]{figs/pid_pipm.png}
\column{0.48\textwidth}
...
\centering\includegraphics[height=.80\textheight]{figs/gallery.png}\\
