/// @file score_gate_dt_sim.C
/// @brief Score a hand-drawn (d,t) PID gate against MC truth, PER STATE.
///
...
/// else; a gate with 95% on the g.s. and 80% on the 6.358 silently rescales the level ratios,
...
///
///   root -b -q 'score_gate_dt_sim.C("triton_dt_sim.json","data/pid_plane_dt_sim.root")'
void score_gate_dt_sim(TString gateFile = "triton_dt_sim.json",
                       TString cache = "data/pid_plane_dt_sim.root")
{
   ...
   const char *nm[5] = {"gs  0.000", "ex1 0.740", "ex2 3.103", "ex3 4.657", "ex4 6.358"};
