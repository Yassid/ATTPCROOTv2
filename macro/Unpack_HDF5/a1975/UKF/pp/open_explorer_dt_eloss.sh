...
OUT="$HOME/a1975_C16_dt_eloss_explorer.html"
MK="$HERE/../../../a2091/UKF/pp/make_explorer_html.C"

C_NEW="/mnt/f/a1975/caches/dt_kin_cateloss.root"
C_OLD="/mnt/f/a1975/caches/dt_kin_catima.root"
...
root -b -l -q "$HERE/mkexp_pp.C(\"$C_NEW\",\"$TMP/exp_dt_new.root\",1e8,900,1400,\"ke\",\"theta\")"
root -b -l -q "$HERE/mkexp_pp.C(\"$C_OLD\",\"$TMP/exp_dt_old.root\",1e8,900,1400,\"ke\",\"theta\")"
...
root -b -l -q "$MK(\"$TMP/exp_dt_new.root\",\"$OUT\",\"16C(d,t)15C  native CATIMA dE/dx vs table vs Spyral\",$EBEAM,16.0147013,2.0135532,3.01550072,15.0105993,16,\"0:g.s.,0.740:5/2+,1.218:Sn,3.103,4.220,4.657\",\"$TMP/exp_dt_old.root\",\"$TMP/exp_dt_spy.root\",\"CATIMA_native,CATIMA_table,Spyral_solver\")"
