...
KECUTHI="${6:-1000}"
TAG="${7:-}"
CACHE="/mnt/f/a1975/caches/dp_kin_dv1104.root"
...
root -b -l -q "$HERE/mkexp_pp.C(\"$CACHE\",\"$TMP/exp_dp1104.root\",1e9,$ICMIN,$ICMAX)"
# 17C levels: the three BOUND states (unresolved here at FWHM ~0.85), Sn, then the resonances
# from the C17_dp_fits analysis.
root -b -l -q "$MK(\"$TMP/exp_dp1104.root\",\"$OUT\",\"16C(d,p)17C  dv 1.10424  CATIMA\",$EBEAM,16.0147013,2.0135532,1.00727646688,17.0225864,16,\"0:g.s.,0.217:1/2+,0.331:5/2+,0.729:Sn,2.763,3.661,4.231,4.841\",\"\")"
