#!/usr/bin/env bash
# Build the (d,t) kinematics cache for the dv 1.10424 production.
#
...
NPAR="${1:-6}"
WORK="${2:-/mnt/f/a1975/caches/.dv1104}"
OUT=/mnt/f/a1975/caches/dt_kin_dv1104.root
FIT=/mnt/f/a1975/gf_dt_dv1104/
EBEAM=184.17
