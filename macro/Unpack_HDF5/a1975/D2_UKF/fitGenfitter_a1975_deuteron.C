...
///
/// Reads reco_d2/<run>_reco.root (AtPatternEvent), writes <run>_genfitter_d<suffix>.root
...
void fitGenfitter_a1975_deuteron(TString fileName = "run_0016", Long64_t nEvents = -1,
