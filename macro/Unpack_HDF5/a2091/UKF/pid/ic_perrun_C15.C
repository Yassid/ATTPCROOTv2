/// @file ic_perrun_C15.C
/// @brief Per-run ATTPCROOT IC amplitude spectra for the a2091 15C runs.
///        The 15C runs span 0011-0069 and were taken with different beam tunes, so the
...
///
///   root -b -q 'pid/ic_perrun_C15.C("run_0033,run_0138,...")'
void ic_perrun_C15(TString runsCSV = "run_0033,run_0138,run_0056,run_0057,run_0058",
                   TString inDir = "/home/yassid/a2091_C15_reco_slim/", Int_t icTbLo = 1050,
                   Int_t icTbHi = 1250, TString outTag = "")
{
   ...
   hists[0]->SetTitle("a2091 15C: IC amplitude per run (area-normalised);ic_amplitude [ADC];fraction/bin");
   ...
   leg->Draw();
   TString png = plotDir + "ic_perrun_C15" + outTag + ".png";
   c->SaveAs(png);
   printf("saved %s\n", png.Data());
}
