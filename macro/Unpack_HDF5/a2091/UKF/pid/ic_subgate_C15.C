...
///
///   root -b -q 'pid/ic_subgate_C15.C("run_0138,run_0058,run_0060,run_0061,run_0062,run_0063,run_0064,run_0065")'
...
void ic_subgate_C15(TString runsCSV, TString inDir = "/home/yassid/a2091_C15_reco_slim/", double icLo = 500,
                                          ...
                                          "UKF/pid/proton_15C.json")
{
   ...
   TString png=plotDir+"ic_subgate_C15.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
