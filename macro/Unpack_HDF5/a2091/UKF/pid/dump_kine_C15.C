/// @file dump_kine_C15.C
/// @brief Dump per-fitted-track kinematics + PID + IC to CSV, for the gated 15C excitation
...
///
///   root -b -q 'dump_kine_C15.C("run_0196,run_0197","_ukf","/home/yassid/a2091_C15_reco/","/home/yassid/a2091_C15_reco/","/tmp/kine_ukf.csv")'
///
/// Columns: ke,theta,chi2ndf,sqrtdedx,brho,vertexz,ic,arclen,npts
void dump_kine_C15(TString runsCSV, TString fitSuffix, TString fitDir, TString fribDir, TString outCsv,
