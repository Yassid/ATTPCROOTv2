...
///        applies the 15C IC beam gate (event-ID matched to <run>_FRIB.root).
///
///   root -b -q 'dump_pid_C15.C("run_0147,run_0148","/home/yassid/a2091_C15_reco/","/tmp/pid_tc.csv")'
///   with IC gate: pass fribDir + icLo/icHi (>0) -> only 15C-beam tracks are written.
void dump_pid_C15(TString runsCSV, TString recoDir, TString outCsv, TString fribDir = "", double icLo = -1,
