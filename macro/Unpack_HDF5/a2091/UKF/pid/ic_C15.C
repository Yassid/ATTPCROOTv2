/// @file ic_C15.C
/// @brief ATTPCROOT Ion Chamber spectrum for a2091 15C, from <run>_FRIB.root.
///        IC = generic trace[0]; ic_amplitude = baseline-subtracted peak in the IC
///        time window [icTbLo, icTbHi] (peak sits at TB~1132 for a2091). This is the
///        ATTPCROOT-side beam-ID used to gate the 15C beam species.
///
///   root -b -q 'ic_C15.C("run_0138")'
///   root -b -q 'ic_C15.C("run_0147,run_0148,run_0149,run_0150")'
void ic_C15(TString runsCSV = "run_0138", TString inDir = "/home/yassid/a2091_C15_reco/", Int_t icTbLo = 1000,
             Int_t icTbHi = 1350, TString outTag = "")
{
   ...
   TH1D *hAmp = new TH1D("hAmp", "ATTPCROOT IC amplitude (15C beam ID);ic_amplitude [ADC];events", 500, 0, 4096);
   ...
   c->cd(2);
   hAmpTb->Draw("colz");
   TString png = plotDir + "ic_C15_attpc" + outTag + ".png";
   c->SaveAs(png);
   printf("saved %s\n", png.Data());
}
