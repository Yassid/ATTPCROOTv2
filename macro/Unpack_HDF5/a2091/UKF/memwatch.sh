#!/bin/bash
# Memory AND host-disk watchdog for the a2091 15C batches.
#
...
# truncating three in-flight recos (run_0138/0058/0060). Guest df showed 814 GB "free"
...
LOG="/home/yassid/a2091_C15_reco/memwatch.log"
kill_jobs(){
  pkill -f "reco_hdb_C15.sh"; pkill -f "frib_C15_batch.sh"; pkill -f "follow_C15.sh"
  pkill -f "unpackReco_C15.C"; pkill -f "unpackFRIB_C15.C"
}
while true; do
