...
/// @brief Unpack ONLY the FRIB DAQ group (frib/evt/*_1903) of a1975 D2 (15C+d) HDF5 with
...
void unpackFRIB_C15d(TString fileName = "run_0017", TString outDir = "/home/yassid/C15d_ic/tmp/",
                     TString filepath = "/media/yassid/Seagate Hub/ATTPC/Data/a1975/h5/")
{
   ...
   TString digiParFile = dir + "/parameters/ATTPC.C15d_D2_300torr.par";
