...
/// i.e. ~54 GB over the 105 a1975 runs. The analysis only ever uses TWO numbers per event:
...
///
///   root -b -q 'pipeline/icsum_C15d.C("run_0017","/path/to/frib/","/home/yassid/C15d_ic/")'
...
void icsum_C15d(TString run, TString inDir = "/home/yassid/C15d_ic/tmp/",
               TString outDir = "/home/yassid/C15d_ic/", Int_t icTbLo = 1050, Int_t icTbHi = 1250,
