/// @file unpackFRIB_Be12.C
/// @brief Unpack ONLY the FRIB DAQ group (frib/evt/*_1903) of a1954 12Be HDF5 with
///        AtFRIBHDFUnpacker -> <run>_FRIB.root (AtRawEvent of the 8 auxiliary channels).
///        The ION CHAMBER is generic trace[0]; used for the 12Be beam gate.
///        Fast (no PSA/PRA) — just reads the small frib group.
///
///   root -b -q 'unpackFRIB_Be12.C("run_0147")'
void unpackFRIB_Be12(TString fileName = "run_0147", TString outDir = "/home/yassid/a1954_Be12_reco/",
