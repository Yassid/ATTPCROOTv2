...
///
///   root -b -q 'pid/ic_subgate_Be12.C("run_0142,run_0143,run_0147,run_0148,run_0150,run_0200,run_0201,run_0202")'
...
void ic_subgate_Be12(TString runsCSV, TString inDir = "/home/yassid/a1954_Be12_reco_hdb_slim/", double icLo = 500,
                                          ...
                                          "UKF/pid/proton_12Be.json")
{
   ...
   TString png=plotDir+"ic_subgate_Be12.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
