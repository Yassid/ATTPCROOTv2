...
///
///   root -b -q 'pid/show_gates_Be12.C("run_0142,run_0143,run_0147,run_0148,run_0150,run_0200")'
...
void show_gates_Be12(TString runsCSV = "run_0142,run_0143,run_0147,run_0148,run_0150,run_0200",
                     TString inDir = "/home/yassid/a1954_Be12_reco_hdb_slim/", double icLo = 500, double icHi = 900,
                                          ...
                                          "UKF/pid/proton_12Be.json")
{
   ...
   TH2F *hPID = new TH2F("hPID", "12Be-gated PID (red = proton_12Be gate);#sqrt{dEdx};B#rho [T m]", 300, 0, 45, 300, 0, 1.2);
   ...
   printf("events=%ld  12Be-IC-gated=%ld (%.1f%%)\n", nAll, nIC, nAll?100.0*nIC/nAll:0);
   ...
   TString png=plotDir+"show_gates_Be12.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
