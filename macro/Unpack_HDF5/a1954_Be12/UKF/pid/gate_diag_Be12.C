...
///
///   root -b -q 'pid/gate_diag_Be12.C("run_0142,run_0143,run_0147,run_0148,run_0150")'
...
void gate_diag_Be12(TString runsCSV = "run_0142,run_0143,run_0147,run_0148,run_0150",
                    TString inDir = "/home/yassid/a1954_Be12_reco_hdb_slim/", Int_t icTbLo = 1050, Int_t icTbHi = 1250,
                    double bField = 2.85,
                    TString protonGate = "/home/yassid/fair_install/ATTPCROOTv2-OpenKF/macro/Unpack_HDF5/a1954_Be12/"
                                         "UKF/pid/proton_band_Be12.json")
{
   ...
   TString png=plotDir+"gate_diag_Be12.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
