...
# writes geometry/ATTPC_H300torr_RT.root and ATTPC_H300torr_RT_geomanager.root
\end{lstlisting}
...
\code{GasPressure}   & 300 torr & H$_2$ \\
...
\begin{lstlisting}
root -b -q -l "$HERE/pipeline/fitUKF_Be12.C(\"run_0147\",-1,\"proton\",-1,2.85,3.308e-5,\
...
6  & \code{gasDensity}    & 3.308e-5 & g/cm$^3$, feeds CATIMA (H$_2$ 300 torr) \\
...
root -b -q -l "$HERE/pipeline/fitGenfit_Be12.C(\"run_0147\",-1,\"<inDir>\",\"\",\"<outDir>\",\
  -2.85,2,5,\"\",4.0,10.0,170.0,kTRUE,kFALSE,\"proton\",\"ATTPC_H300torr_RT\")"
\end{lstlisting}
...
16 & \code{geoName}        & \code{ATTPC_H300torr_RT} & must match the real gas density \\
\bottomrule
\end{longtable}
...
\code{gasDensity}     & 3.308e-5  & CATIMA density, H$_2$ at 300 torr / 293~K. Matches \code{media.geo} \code{H\_300torr\_RT} exactly. \textbf{Everything produced before 2026-08-25 used 6.5e-5, i.e.\ twice the material.} \\
...
\code{geoName}      & \code{ATTPC_H300torr_RT} & Material effects are only as good as the density. \\
...
root -b -q $REPO/geometry/ATTPC_H300torr_RT.C     # once per clone
