...
/// unpackReco_C15p.C) and writes <run>_pid.root holding one entry PER TRACK.
///
///   root -b -q 'pidntuple_C15p.C("run_0017", "/home/yassid/a2091_C15_reco/", "/home/yassid/a2091_C15_ic/")'
///
...
void pidntuple_C15p(TString fileName = "run_0138", TString inDir = "/home/yassid/C15p_reco/",
                    TString outDir = "", TString recoSuffix = "_reco", TString treeName = "cbmsim")
{
   ...
   if (tree->GetBranch("AtPIDEvent") == nullptr) {
      std::cout << "\033[1;31mERROR: " << inputFile << " has no AtPIDEvent branch.\n"
                << "  Re-reco with doPID=kTRUE (unpackReco_C15p.C default).\033[0m\n";
      return;
   }
