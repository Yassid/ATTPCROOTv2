#!/usr/bin/env python3
"""Add the per-run Ex map to a generated C15p explorer page.

    python3 pp/inject_run_panel.py <explorer.html> [out.html]
...
SCRIPT = '''
<script>
/* ---- per-run Ex map (injected by pp/inject_run_panel.py) --------------------------------- */
(function(){
