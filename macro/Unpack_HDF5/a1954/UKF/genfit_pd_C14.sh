#!/bin/bash
# GENFIT pass over the ALREADY-GATED (p,d) inputs written by fitpipe_pd_C14.sh, so the
...
#   ./genfit_pd_C14.sh "run_0143 run_0147" 4
RUNS="${1:-run_0143}"; NPAR="${2:-4}"
REPO="/home/yassid/fair_install/ATTPCROOTv2-OpenKF"
HERE="$REPO/macro/Unpack_HDF5/a1954/UKF"
FITDIR="/home/yassid/a1954_C14_fit_pd/"; IN="${FITDIR}in/"; LOG="${FITDIR}logs"
OUTDIR="${OUTDIR:-/home/yassid/a1954_C14_genfix_pd/}"; mkdir -p "$OUTDIR"
...
one(){ local r="$1"; local L="$LOG/${r}_genfit.log"
  ...
  root -b -q -l "$HERE/pipeline/fitGenfit_C14.C(\"$r\",-1,\"$IN\",\"\",\"$OUTDIR\",-2.85,2,5,\"\",4.0,5.0,170.0,kTRUE,kFALSE,\"deuteron\")" > "$L" 2>&1
