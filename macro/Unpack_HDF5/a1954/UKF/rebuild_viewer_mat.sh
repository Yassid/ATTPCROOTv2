...
P="$HERE/pp/plots"
MATDIR="/home/yassid/a1954_C14_genfit_mat/"
CHAINLOG="/home/yassid/a1954_C14_genfit_mat_chain.log"
OUT="/home/yassid/a1954_C14_pp_300torr.html"
WINHOME="/mnt/c/Users/Yassid"
RUNS="run_0055,run_0056,run_0057,run_0058,run_0059,run_0060,run_0061,run_0062,run_0063,run_0064,run_0065,run_0066,run_0068,run_0069"
...
root -b -q -l "pp/ex_C14.C(\"$RUNS\",\"$MATDIR\",161.0,5.0,\"_300_genfit_mat\",1.007825,14.003242,\"\",\"genfit\")" 2>&1 | grep "good track"

echo "[$(date +%H:%M:%S)] rebuilding the explorer..."
root -b -q -l "pp/make_explorer_html.C(\"$P/proton_kin_300_ukf.root\",\"$OUT\",\"14C(p,p') 300 torr + matEffects - 14 runs\",161,14.003242,1.007825,1.007825,14.003242,14,\"6.09,6.59,6.73,6.90,7.01,7.34\",\"$P/proton_kin_300_genfit_mat.root\")" 2>&1 | grep -E "wrote|UKF |GENFIT "
...
for c in 300_ukf 300_genfit 300_genfit_mat; do
  printf "  %-16s " "$c"
  root -b -q -l "pp/hyp_C14.C(\"plots/proton_kin_$c.root\",161,\"$c\")" 2>&1 | grep "(0) as measured" | sed 's/(0) as measured *: //'
done
