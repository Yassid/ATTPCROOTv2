...
///
///   root -b -q 'pid/show_gates_C14.C("run_0055,run_0058,run_0060,run_0061,run_0064")'
...
void show_gates_C14(TString runsCSV = "run_0055,run_0058,run_0060,run_0061,run_0064",
                     TString inDir = "/home/yassid/a1954_C14_reco_hdb_slim/", double icLo = 500, double icHi = 900,
                                          ...
                                          "UKF/pid/proton_14C.json")
{
   ...
   TH2F *hPID = new TH2F("hPID", "14C-gated PID (red = proton_14C gate);#sqrt{dEdx};B#rho [T m]", 300, 0, 45, 300, 0, 1.2);
   ...
   printf("events=%ld  14C-IC-gated=%ld (%.1f%%)\n", nAll, nIC, nAll?100.0*nIC/nAll:0);
   ...
   TString png=plotDir+"show_gates_C14.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
