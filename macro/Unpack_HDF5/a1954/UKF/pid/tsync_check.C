...
void tsync_check(TString run, TString recoDir = "/home/yassid/a1954_C14_reco_hdb/",
                 TString fribDir = "/home/yassid/a1954_C14_reco_hdb_slim/")
{
   ...
   // The two DAQ clocks do NOT always tick at the same rate in a1954: in the early 14C runs
   // pad ts1 shares the FRIB clock (scale 1), while from ~run_0055 on both pad timestamps run
