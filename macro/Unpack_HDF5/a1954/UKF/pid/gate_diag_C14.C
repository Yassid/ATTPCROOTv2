...
///
///   root -b -q 'pid/gate_diag_C14.C("run_0055,run_0058,run_0060,run_0148,run_0150")'
...
void gate_diag_C14(TString runsCSV = "run_0055,run_0058,run_0060,run_0148,run_0150",
                    TString inDir = "/home/yassid/a1954_C14_reco_hdb_slim/", Int_t icTbLo = 1050, Int_t icTbHi = 1250,
                    double bField = 2.85,
                    TString protonGate = "/home/yassid/fair_install/ATTPCROOTv2-OpenKF/macro/Unpack_HDF5/a1954/"
                                         "UKF/pid/proton_band_C14.json")
{
   ...
   TString png=plotDir+"gate_diag_C14.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
}
