/// @file compare_fitters_C14.C
/// @brief UKF vs GENFIT on the doubly-gated 14C proton sample. KE-vs-theta (2D + profile),
...
///
///   root -b -q 'pp/compare_fitters_C14.C("run_0055,run_0058,...","/home/yassid/a1954_C14_fit/")'
void compare_fitters_C14(TString runsCSV, TString fitDir = "/home/yassid/a1954_C14_fit/")
{
   gSystem->Load("libAtReconstruction.so");
   gStyle->SetOptStat(0); gStyle->SetPalette(kBird); gStyle->SetNumberContours(255);
   TString plotDir = TString(getenv("VMCWORKDIR")) + "/macro/Unpack_HDF5/a1954/UKF/pp/plots/";
   ...
   TString png=plotDir+"compare_fitters_C14.png"; c->SaveAs(png); printf("saved %s\n",png.Data());
   ...
   TString png2=plotDir+"compare_fitters_chi2_C14.png"; c2->SaveAs(png2); printf("saved %s\n",png2.Data());
}
