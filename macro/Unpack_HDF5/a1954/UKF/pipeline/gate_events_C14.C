/// @file gate_events_C14.C
/// @brief Build a small FIT INPUT holding only IC-gated (14C) events AND, within them,
...
///
///   root -b -q 'gate_events_C14.C("run_0055", ...)'
...
void gate_events_C14(TString run, TString inDir = "/home/yassid/a1954_C14_reco_hdb_slim/",
                      TString outDir = "/home/yassid/a1954_C14_fit/in/", TString refReco = "", double icLo = 950,
                      double icHi = 1350, Int_t icTbLo = 1050, Int_t icTbHi = 1250, double bField = 2.85,
